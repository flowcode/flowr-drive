...
class FileControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/drive/file/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'file[name]' => 'Lorem ipsum dolor sit amet',
            'file[path]' => 'Lorem ipsum dolor sit amet',
            'file[type]' => 'Lorem ipsum dolor sit amet',
            'file[archived]' => true,
            'file[created]' => new \DateTime(),
            'file[updated]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/drive/file/new');
